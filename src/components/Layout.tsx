...
export function Header({ onNavigate, currentPath }: NavProps) {
  ...
  return <header className="site-header"><div className="header-inner">
    <button className="brand" onClick={goHome} aria-label="MAXIM 홈"><img src="/assets/img/logo.png" alt="MAXIM" /></button>
...
export function Footer() { return <footer className="site-footer"><img src="/assets/img/logo.png" alt="MAXIM" /><div><p><strong>개인정보처리방침</strong><span>이용약관</span><span>이메일무단수집거부</span></p><p>서울시 마포구 독막로 324 동서빌딩 · 전국대표전화번호 1588-2233</p><small>2013 DONG SUH FOOD. ALL RIGHT RESERVED.</small></div></footer> }
